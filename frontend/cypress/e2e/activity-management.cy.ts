describe('Activity Management', () => {
  ...
  it('should create a new activity with autocomplete', () => {
    ...
    cy.get('input[placeholder*="Reading, Exercise, Coding"]').type('{backspace}{backspace}')
    ...
    cy.get('input[placeholder*="Reading, Exercise, Coding"]').clear().type('Reading Books')
    cy.get('textarea[placeholder*="Optional notes"]').type('Reading a great novel')
  ...
  it('should edit an existing activity', () => {
    ...
    // Edit the activity
    cy.get('input[placeholder*="Reading, Exercise, Coding"]').clear().type('Updated Reading')
    cy.get('textarea[placeholder*="Optional notes"]').clear().type('Updated description')
  ...
  it('should validate required fields', () => {
    ...
    cy.get('input[placeholder*="Reading, Exercise, Coding"]:invalid').should('exist')
  })
