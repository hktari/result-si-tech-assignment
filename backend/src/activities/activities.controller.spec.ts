...
describe('ActivitiesController', () => {
  ...
  describe('create', () => {
    it('should create activity successfully', async () => {
      ...
      // Act
      const actualResult = await activitiesController.create(
        mockRequest,
        inputCreateDto
      )
  ...
  describe('findOne', () => {
    it('should return single activity', async () => {
      ...
      // Act
      const actualResult = await activitiesController.findOne(
        inputId,
        mockRequest
      )
  ...
  describe('update', () => {
    it('should update activity successfully', async () => {
      ...
      // Act
      const actualResult = await activitiesController.update(
        inputId,
        mockRequest,
        inputUpdateDto
      )
  ...
  describe('remove', () => {
    it('should delete activity successfully', async () => {
      ...
      // Act
      const actualResult = await activitiesController.remove(
        inputId,
        mockRequest
      )
  ...
  describe('getTodayActivities', () => {
    it("should return today's activities", async () => {
      ...
      mockActivitiesService.getTodayActivities.mockResolvedValue(
        expectedActivities
      )

      // Act
      const actualResult =
        await activitiesController.getTodayActivities(mockRequest)

      // Assert
      expect(actualResult).toEqual(expectedActivities)
      expect(mockActivitiesService.getTodayActivities).toHaveBeenCalledWith(
        mockRequest.user.id
      )
    })
  })
  ...
  describe('getActivitySuggestions', () => {
    it('should return activity suggestions with query', async () => {
      ...
      mockActivitiesService.getActivitySuggestions.mockResolvedValue(
        expectedSuggestions
      )

      // Act
      const actualResult = await activitiesController.getSuggestions(
        mockRequest,
        inputQuery
      )
